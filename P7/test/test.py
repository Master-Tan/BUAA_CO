...
for mipsDir in mipsDirs:
    ...
    spMarsJarDir = "Mars_P6.jar"  # 修改版Mars地址
    ...
    print("Checking \"" + mipsDir + "\" ...")
    os.system("d:/Xilinx/14.7/ISE_DS/ISE/bin/nt64/fuse -nodebug -intstyle silent -prj " +
              testDir + "/test.prj" + " -o " + "testmips.exe mips_txt>" +
              iseCompileLogDir)
